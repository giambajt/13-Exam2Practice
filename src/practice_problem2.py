...
def run_test_practice_problem2a():
    ...
    print()
    expected = [9,11,28]
    actual = practice_problem2a([4,6,23], 5)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 2
    print()
    expected = [106, 9, 31, 75, 11]
    actual = practice_problem2a([98, 1, 23, 67, 3], 8)
    print('Expected:', expected)
    print('Actual:  ', actual)
    ...
    print()
    expected = [174]
    actual = practice_problem2a([9], 165)
    print('Expected:', expected)
    print('Actual:  ', actual)

    # Test 4
    print()
    expected = [5,7,34,76,98,2]
    actual = practice_problem2a([5,7,34,76,98,2], 0)
    print('Expected:', expected)
    print('Actual:  ', actual)
